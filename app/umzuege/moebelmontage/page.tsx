...
export const metadata = createSeoMetadata(seoPages.moebelmontage);
...
const benefits = [
  {
    ...
    text: "Möbel werden sauber, stabil und mit dem nötigen Werkzeug montiert oder demontiert.",
  },
  {
    title: "Weniger Aufwand",
    text: "Sie sparen Zeit und müssen sich nicht selbst mit Schrauben, Aufbauplänen und schweren Möbelteilen beschäftigen.",
  },
  {
    title: "Sicherer Transport",
    text: "Große Möbelstücke können bei Bedarf zerlegt und transportsicher vorbereitet werden.",
  },
  {
    title: "Alles aus einer Hand",
    text: "Umzug, Transport, Demontage und Montage werden sinnvoll miteinander abgestimmt.",
  },
];
...
const process = [
  {
    ...
    text: "Sie sagen uns, welche Möbel montiert oder demontiert werden sollen.",
  },
  {
    title: "Umfang klären",
    text: "Wir besprechen Möbelart, Anzahl, Etagen, Zugang und ob ein Umzug damit verbunden ist.",
  },
  {
    title: "Demontage vorbereiten",
    text: "Möbel werden fachgerecht zerlegt, Schrauben gesichert und Teile transportbereit gemacht.",
  },
  {
    title: "Montage durchführen",
    text: "Am Zielort bauen wir Ihre Möbel sauber, stabil und zuverlässig wieder auf.",
  },
];
...
const checklist = [
  "Welche Möbel sollen montiert werden?",
  "Demontage oder Aufbau nötig?",
  "Anzahl der Möbelstücke",
  "Etage, Aufzug und Zugang",
  "Umzug direkt damit verbunden?",
  "Besondere Möbel oder Maße?",
];
...
<ServiceJsonLd
  ...
  description="Möbelmontage und Demontage in Landshut mit Umzüge LAF. Fachgerechter Aufbau von Schränken, Betten, Regalen und Möbeln beim Umzug."
      ...
      <section className="relative z-10 min-h-[90vh] overflow-hidden px-5 pb-20 pt-40 lg:px-8">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Möbelmontage von Umzüge LAF in Landshut"
            fill
            priority
        ...
        <div className="relative mx-auto flex min-h-[72vh] max-w-7xl items-center">
          <div className="max-w-4xl">
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-[#f6c21a]/40 bg-white/10 px-4 py-2 text-sm font-black text-[#f6c21a] shadow-[0_0_40px_rgba(246,194,26,0.16)] backdrop-blur-xl">
              ...
              Möbelmontage in Landshut & Umgebung
            </div>
            ...
            <h1 className="max-w-5xl text-5xl font-black leading-[0.92] tracking-[-0.06em] text-white drop-shadow-2xl md:text-7xl lg:text-8xl">
              Möbel abbauen.
              <span className="gradient-text block">Sicher transportieren.</span>
              Sauber aufbauen.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/84 drop-shadow md:text-xl">
              Ob Schrank, Bett, Regal, Kommode oder Büroeinrichtung: Umzüge LAF
              übernimmt die fachgerechte Demontage und Montage Ihrer Möbel —
              zuverlässig, sauber und passend zum Umzug geplant.
            </p>
            ...
            <div className="mt-12 grid max-w-3xl gap-4 sm:grid-cols-3">
              {["Demontage", "Transport", "Montage"].map((item) => (
                <div
                  key={item}
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              Große Möbel brauchen einen sauberen Plan.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/65">
              Viele Möbelstücke lassen sich nicht einfach transportieren. Wir
              demontieren Ihre Möbel fachgerecht, sichern Kleinteile und bauen
              alles am neuen Standort wieder ordentlich auf.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-black shadow-[0_30px_100px_rgba(0,0,0,0.25)]">
            <div className="relative h-[560px]">
              <Image
                src="/images/services/Montage.jpg"
                alt="Möbelmontage und Demontage mit Umzüge LAF"
                fill
              ...
              <div className="absolute bottom-6 left-6 right-6 rounded-[1.7rem] border border-white/10 bg-black/55 p-6 text-white backdrop-blur-xl">
                ...
                <h3 className="mt-3 text-3xl font-black">
                  Möbel fachgerecht zerlegen, sichern und wieder aufbauen.
                </h3>
                <p className="mt-3 leading-7 text-white/65">
                  Wir achten auf Schrauben, Beschläge, empfindliche Oberflächen
                  und einen sicheren Aufbau am Zielort.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative z-10 bg-[#050505] px-5 py-28 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-14 max-w-3xl">
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              Möbelmontage ohne Stress, Chaos und verlorene Schrauben.
            </h2>

            <p className="mt-6 text-lg leading-8 text-white/65">
              Mit unserem Montageservice wird Ihr Umzug deutlich einfacher —
              besonders bei großen Möbeln, engen Treppenhäusern oder schweren
              Teilen.
            </p>
          </div>
      ...
      <section className="relative z-10 bg-[#f7f7f2] px-5 py-28 text-black lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-black/65">
              Wir stimmen die Montage passend zu Ihrem Umzug, Ihren Möbeln und
      ...
      <section className="relative z-10 bg-[#050505] px-5 py-28 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-white/65">
              Je genauer wir wissen, welche Möbel betroffen sind, desto besser
              können wir Werkzeug, Zeit und Teamgröße einschätzen.
            </p>
            ...
            {checklist.map((item) => (
              ...
              >
                ...
                <p className="mt-2 text-sm leading-6 text-white/55">
                  Hilft uns bei der genauen Planung Ihrer Möbelmontage.
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.7rem] bg-black shadow-[0_35px_120px_rgba(0,0,0,0.22)]">
          <div className="grid lg:grid-cols-[1fr_0.9fr]">
            <div className="relative min-h-[460px]">
              <Image
                src="/images/services/Montage.jpg"
                alt="Möbelmontage Landshut mit Umzüge LAF"
                fill
                className="object-cover"
              />
            ...
            <div className="flex flex-col justify-center p-8 text-white md:p-12">
              ...
              <p className="mt-6 text-lg leading-8 text-white/65">
                Schreiben Sie kurz, welche Möbel montiert oder demontiert werden
                sollen. Wir melden uns schnell zurück und planen den passenden
                Ablauf.
              </p>
