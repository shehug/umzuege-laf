...
import styles from "./verpackservice.module.css";
...
const benefits = [
  {
    title: "Zeit sparen",
    text: "Wir übernehmen das sichere Einpacken, damit Sie sich um andere Dinge rund um den Umzug kümmern können.",
  },
  {
    title: "Sicher verpackt",
    text: "Empfindliche Gegenstände, Geschirr, Glas, Deko und Technik werden sorgfältig geschützt.",
  },
  {
    title: "Ordentlich sortiert",
    text: "Kartons werden sinnvoll gepackt und auf Wunsch beschriftet, damit am neuen Ort alles schneller gefunden wird.",
  },
  {
    title: "Weniger Stress",
    text: "Unser Team arbeitet ruhig, sauber und strukturiert — ideal, wenn es schnell oder umfangreich werden soll.",
  },
];
...
const process = [
  {
    ...
    text: "Sie sagen uns, was eingepackt werden soll und wann der Umzug geplant ist.",
  },
  {
    title: "Umfang klären",
    text: "Wir besprechen Räume, Kartonmenge, empfindliche Gegenstände und benötigtes Material.",
  },
  {
    title: "Einpacken vorbereiten",
    text: "Kartons, Schutzmaterial, Klebeband und Verpackung werden passend eingeplant.",
  },
  {
    title: "Sicher verpacken",
    text: "Unser Team packt Ihre Gegenstände fachgerecht ein und bereitet alles für den Transport vor.",
  },
];
...
const included = [
  ...
  "Geschirr verpacken",
  "Glas & Deko schützen",
  "Kleidung & Bücher packen",
  "Kartons beschriften",
  "Verpackungsmaterial",
  "Optionaler Auspackservice",
];
...
const checklist = [
  ...
  "benötigte Kartons",
  "Verpackungsmaterial nötig?",
  "Auspackservice gewünscht?",
];
...
<BreadcrumbJsonLd
  items={[
    ...
    { name: "Einpackservice", path: "/umzuege/einpackservice" },
  ]}
/>

<ServiceJsonLd
  name="Einpackservice Landshut"
  description="Einpackservice und Verpackungsservice in Landshut mit Umzüge LAF. Fachgerechtes Verpacken von Geschirr, Kleidung, Büchern, Deko und empfindlichen Gegenständen."
...
/>
      ...
      <section className="relative z-10 min-h-[90vh] overflow-hidden px-5 pb-20 pt-40 lg:px-8">
        <div className="absolute inset-0">
          <Image
            src="/images/services/Verpacken.jpg"
            alt="Einpackservice von Umzüge LAF in Landshut"
            fill
            priority
        ...
        <div className="relative mx-auto grid min-h-[72vh] max-w-7xl items-center gap-12 lg:grid-cols-[1.05fr_0.95fr]">
          <div className="max-w-4xl">
            <div className="mb-7 inline-flex items-center gap-3 rounded-full border border-[#f6c21a]/40 bg-white/10 px-4 py-2 text-sm font-black text-[#f6c21a] shadow-[0_0_40px_rgba(246,194,26,0.16)] backdrop-blur-xl">
              ...
              Einpackservice in Landshut & Umgebung
            </div>
            ...
            <h1 className="max-w-5xl text-5xl font-black leading-[0.92] tracking-[-0.06em] text-white drop-shadow-2xl md:text-7xl lg:text-8xl">
              Wir packen ein.
              <span className="gradient-text block">Sicher geschützt.</span>
              Stressfrei umziehen.
            </h1>

            <p className="mt-7 max-w-2xl text-lg leading-8 text-white/84 drop-shadow md:text-xl">
              Ob Geschirr, Kleidung, Bücher, Dekoration oder empfindliche
              Gegenstände: Umzüge LAF übernimmt das fachgerechte Einpacken und
              bereitet Ihr Zuhause sauber für den Umzug vor.
            </p>
            ...
            <div className="mt-12 grid max-w-3xl gap-4 sm:grid-cols-3">
              {["Einpacken", "Schützen", "Beschriften"].map((item) => (
                <div
                  key={item}
                ...
                >
                  ...
                  <p className="mt-2 text-sm leading-6 text-white/65">
                    sorgfältig vorbereitet und transportsicher umgesetzt
                  </p>
                </div>
              ))}
            </div>
            ...
            <div className="premium-border rounded-[2.5rem] bg-black/45 p-5 shadow-[0_30px_100px_rgba(0,0,0,0.35)] backdrop-blur-xl">
              <div className={styles.animationCard}>
                <div className={styles.animationStage}>
                  ...
                  <div className={`${styles.flyingItem} ${styles.itemTwo}`}>
                    <span>Glas</span>
                  </div>

                  <div className={`${styles.flyingItem} ${styles.itemThree}`}>
                    <span>Deko</span>
                  </div>

                  <div className={`${styles.flyingItem} ${styles.itemFour}`}>
                    <span>Shirt</span>
                  </div>
                ...
                <div className="mt-5 rounded-[1.5rem] border border-white/10 bg-white/[0.06] p-5">
                  ...
                  <h3 className="mt-3 text-2xl font-black text-white">
                    Kartons packen lassen statt Umzugsstress.
                  </h3>
                  <p className="mt-3 leading-7 text-white/60">
                    Wir bringen Struktur in Ihren Umzug und sorgen dafür, dass
                    alles sicher vorbereitet ist.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              Wenn alles sicher ankommen soll, beginnt der Umzug beim Verpacken.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/65">
              Ein guter Umzug startet nicht erst beim Transport. Richtig
              verpackte Gegenstände sparen Zeit, vermeiden Schäden und sorgen
              dafür, dass am neuen Wohnort alles geordnet ankommt.
            </p>
            ...
            <div className="relative h-[560px]">
              ...
              <div className="absolute bottom-6 left-6 right-6 rounded-[1.7rem] border border-white/10 bg-black/55 p-6 text-white backdrop-blur-xl">
                ...
                <h3 className="mt-3 text-3xl font-black">
                  Verpackungsmaterial, Kartons und Schutz im richtigen Ablauf.
                </h3>
                <p className="mt-3 leading-7 text-white/65">
                  Wir achten auf stabile Verpackung, klare Sortierung und
                  sicheren Schutz Ihrer Gegenstände.
                </p>
              </div>
            </div>
          </div>
      ...
      <section className="relative z-10 bg-[#050505] px-5 py-28 lg:px-8">
        <div className="mx-auto max-w-7xl">
          <div className="mb-14 max-w-3xl">
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              Einpackservice für einen ruhigen und sicheren Umzug.
            </h2>

            <p className="mt-6 text-lg leading-8 text-white/65">
              Gerade bei größeren Umzügen oder wenig Zeit ist professionelles
              Einpacken eine echte Entlastung.
            </p>
          </div>
      ...
      <section className="relative z-10 bg-[#f7f7f2] px-5 py-28 text-black lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              So läuft der Einpackservice ab.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/65">
              Wir stimmen den Ablauf passend zu Ihrem Haushalt, Ihren
              Gegenständen und Ihrem Umzugstermin ab.
            </p>
          </div>
      ...
      <section className="relative z-10 bg-[#050505] px-5 py-28 lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[1.05fr_0.95fr] lg:items-start">
          <div>
            ...
            <p className="mt-6 text-lg leading-8 text-white/65">
              Je genauer wir wissen, was eingepackt werden soll, desto besser
              können wir Zeit, Material und Teamgröße einschätzen.
            </p>
            ...
            {checklist.map((item) => (
              ...
              >
                ...
                <p className="mt-2 text-sm leading-6 text-white/55">
                  Hilft uns bei der genauen Planung Ihres Einpackservices.
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.7rem] bg-black shadow-[0_35px_120px_rgba(0,0,0,0.22)]">
          <div className="grid lg:grid-cols-[1fr_0.9fr]">
            <div className="relative min-h-[460px]">
              <Image
                src="/images/services/Verpacken.jpg"
                alt="Einpackservice Landshut mit Umzüge LAF"
                fill
                className="object-cover"
              />
            ...
            <div className="flex flex-col justify-center p-8 text-white md:p-12">
              ...
              <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
                Lassen Sie Ihren Umzug professionell vorbereiten.
              </h2>

              <p className="mt-6 text-lg leading-8 text-white/65">
                Schreiben Sie kurz, wann Sie umziehen und was verpackt werden
                soll. Wir melden uns schnell zurück und planen den passenden
                Ablauf.
              </p>
