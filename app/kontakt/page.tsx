    ...
    <main className="min-h-screen bg-white text-slate-900">
      ...
      <section className="bg-slate-900 pt-28 pb-16 text-white sm:pt-36 sm:pb-24 lg:pt-40 lg:pb-24 border-b border-slate-800">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center">
          ...
          <h1 className="text-3xl font-black tracking-tight text-white sm:text-5xl lg:text-6xl leading-[1.15]">
            Kontaktieren Sie Umzüge LAF.<br />
            <span className="text-amber-400">Schnell, einfach & unverbindlich.</span>
          </h1>
      ...
      <section className="relative z-20 -mt-8 mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between hover:border-amber-400 hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between">
                <span className="rounded-lg bg-amber-100 p-2.5 text-xl">📞</span>
              ...
              <p className="mt-3 text-base font-black text-slate-900">{phone}</p>
            </div>
            <TrackedLink
              href={phoneHref}
              tracking="phone"
          ...
          {/* WhatsApp */}
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between hover:border-green-500 hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between">
                <span className="rounded-lg bg-green-100 p-2.5 text-xl">💬</span>
              ...
              <p className="mt-3 text-base font-black text-slate-900">Per Chat anfragen</p>
            </div>
            <TrackedLink
              href={whatsappHref}
              tracking="whatsapp"
          ...
          {/* E-Mail */}
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm flex flex-col justify-between hover:border-slate-400 hover:shadow-md transition">
            <div>
              <div className="flex items-center justify-between">
                <span className="rounded-lg bg-slate-100 p-2.5 text-xl">✉️</span>
      ...
      <section className="py-16 sm:py-24 bg-slate-50 border-t border-slate-200 mt-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-start">
            ...
            <div id="anfrageformular" className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm scroll-mt-24">
