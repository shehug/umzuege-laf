...
const benefits = [
  {
    title: "Schnell entrümpelt",
    text: "Wir räumen Wohnungen strukturiert, effizient und mit einem klaren Ablauf — auch bei größerem Umfang.",
  },
  {
  ...
  {
    title: "Saubere DurchführunFg",
    text: "Wir arbeiten ordentlich, zuverlässig und hinterlassen die Räume besenrein nach Absprache.",
  },
  {
    title: "Diskret & zuverlässig",
    text: "Gerade bei sensiblen Situationen gehen wir respektvoll, ruhig und professionell vor.",
  },
];
...
const process = [
  {
    ...
    text: "Sie nennen uns die Adresse, die Wohnungsgröße und den gewünschten Zeitraum.",
  },
  {
    title: "Umfang klären",
    text: "Wir besprechen Möbel, Hausrat, Etage, Zugang und ob bestimmte Gegenstände besonders beachtet werden müssen.",
  },
  {
    title: "Entrümpelung planen",
    text: "Der Ablauf wird so vorbereitet, dass Räumung, Tragen und Abtransport sauber ineinandergreifen.",
  },
  {
    title: "Wohnung entrümpeln",
    text: "Unser Team führt die Wohnungsentrümpelung zuverlässig und organisiert durch.",
  },
];
...
const checklist = [
  ...
  "Möbel oder größere Gegenstände",
  "gewünschter Termin",
];
...
<ServiceJsonLd
  name="Wohnungsentrümpelung Landshut"
  description="Wohnungsentrümpelung in Landshut mit Umzüge LAF. Wohnung zuverlässig räumen, Möbel abtransportieren und Räume nach Absprache sauber übergeben."
  path="/entruempelung/wohnungsentruempelung"
      ...
      <section className="relative z-10 min-h-[90vh] overflow-hidden px-5 pb-20 pt-40 lg:px-8">
        <div className="absolute inset-0">
          <Image
            ...
            alt="Wohnungsentrümpelung von Umzüge LAF in Landshut"
            fill
            priority
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              Wenn eine Wohnung leer werden soll, muss der Ablauf stimmen.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/65">
              Eine Wohnungsentrümpelung bedeutet oft mehr als nur Dinge
              rauszutragen. Möbel, Hausrat, Nebenräume und Zugänge müssen
              sinnvoll geplant werden, damit alles zügig und ordentlich
              abläuft.
            </p>
          ...
          <div className="relative overflow-hidden rounded-[2.5rem] bg-black shadow-[0_30px_100px_rgba(0,0,0,0.25)]">
            <div className="relative h-[560px]">
              <Image
                src="/images/services/ent3.jpg"
                alt="Wohnungsentrümpelung mit Umzüge LAF"
                fill
      ...
      <section className="relative z-10 bg-[#f7f7f2] px-5 py-28 text-black lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              So läuft Ihre Wohnungsentrümpelung ab.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/65">
              Wir stimmen die Entrümpelung passend zu Wohnungsgröße, Zugang und
              Umfang individuell ab.
            </p>
          </div>
        ...
        <div className="mx-auto max-w-7xl overflow-hidden rounded-[2.7rem] bg-black shadow-[0_35px_120px_rgba(0,0,0,0.22)]">
          <div className="grid lg:grid-cols-[1fr_0.9fr]">
            <div className="relative min-h-[460px]">
              <Image
                src="/images/services/ent3.jpg"
                alt="Wohnungsentrümpelung Landshut mit Umzüge LAF"
                fill
                className="object-cover"
              />
