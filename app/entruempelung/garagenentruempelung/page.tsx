...
const benefits = [
  {
    title: "Mehr Platz in der Garage",
    text: "Wir räumen überfüllte Garagen strukturiert frei, damit wieder Ordnung, Stellfläche und Übersicht entstehen.",
  },
  {
    title: "Sperrige Dinge raus",
    text: "Reifen, Regale, Werkzeuge, Altbestände, Kisten und große Gegenstände werden sicher bewegt und abtransportiert.",
  },
  {
    title: "Sauberer Ablauf",
    text: "Gerade bei vollen Garagen braucht es Struktur. Wir arbeiten geordnet, zügig und mit einem klaren Ablauf.",
  },
  {
    title: "Ideal vor Umzug oder Verkauf",
    text: "Eine freie, ordentliche Garage ist besonders hilfreich vor einem Umzug, einer Renovierung oder einer Immobilienübergabe.",
  },
];
...
const process = [
  {
    ...
    text: "Sie nennen uns Adresse, Garagengröße und den gewünschten Zeitraum.",
  },
  {
    title: "Umfang klären",
    text: "Wir besprechen, was sich in der Garage befindet und welche Gegenstände besonders sperrig oder schwer sind.",
  },
  {
    title: "Ablauf planen",
    text: "Wir stimmen Zugang, Tragewege, Arbeitsaufwand und Abtransport passend aufeinander ab.",
  },
  {
    title: "Garage entrümpeln",
    text: "Unser Team räumt die Garage zuverlässig, organisiert und nach Absprache ordentlich.",
  },
];
      ...
      <div className="relative overflow-hidden rounded-[2rem] border border-white/10 bg-[radial-gradient(circle_at_top,rgba(246,194,26,0.16),transparent_32%),linear-gradient(180deg,#171717_0%,#080808_100%)] p-6 md:p-8">
        ...
        <div className="relative z-10">
          ...
          <div className="mt-6 grid grid-cols-3 gap-3">
            {["Reifen", "Werkzeug", "Kisten"].map((item) => (
              <div
                key={item}
...
<ServiceJsonLd
  name="Garagenentrümpelung Landshut"
  description="Garagenentrümpelung in Landshut mit Umzüge LAF. Reifen, Werkzeug, Regale, Kisten und Altbestände aus der Garage zuverlässig entfernen lassen."
  path="/entruempelung/garagenentruempelung"
        ...
        <div className="relative mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              Wenn die Garage wieder für das Wesentliche da sein soll.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/65">
              Garagen werden im Alltag schnell zu Lagerflächen für Kartons,
              Werkzeug, Reifen, Regale und Dinge, die „erst einmal dort“
              abgestellt werden. Wir helfen dabei, diese Flächen geordnet zu
              räumen und wieder sinnvoll nutzbar zu machen.
            </p>
          ...
          <div className="premium-border rounded-[2.5rem] bg-black p-6 shadow-[0_30px_100px_rgba(0,0,0,0.25)]">
            <div className="rounded-[2rem] bg-[linear-gradient(180deg,#0d0d0d_0%,#151515_100%)] p-6 text-white">
              ...
              <div className="mt-8 grid gap-4">
                {[
                  {
                    title: "Reifen, Geräte & Werkzeug",
                    text: "Viele Garagen enthalten schwere oder sperrige Gegenstände, die systematisch geräumt werden müssen.",
                  },
                  {
                    title: "Regale & abgestellte Altbestände",
                    text: "Nicht nur lose Dinge, sondern oft ganze Lagerbereiche müssen sinnvoll geleert werden.",
                  },
                  {
                    title: "Stellfläche wieder nutzbar machen",
                    text: "Das Ziel ist meist klar: wieder Platz für Fahrzeug, Lagerung mit System oder einfach mehr Ordnung.",
                  },
                ].map((item) => (
                  <div
                    key={item.title}
      ...
      <section className="relative z-10 bg-[#f7f7f2] px-5 py-28 text-black lg:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <div>
            ...
            <h2 className="mt-4 text-4xl font-black tracking-[-0.05em] md:text-6xl">
              So läuft Ihre Garagenentrümpelung ab.
            </h2>

            <p className="mt-6 text-lg leading-8 text-black/65">
              Wir stimmen Größe, Inhalt, Zugang und Aufwand individuell auf Ihre
              Garage und Ihre Situation ab.
            </p>
          </div>
